...
if __name__ == "__main__":
    ...
    for tradeDate in [pd.Timestamp("20200102"),
        ...
        Counter.openStock(direction="long", symbol="000001.SH", vol=100, price=15.1, static_profit=None, static_loss=None,
                          dynamic_profit=None, dynamic_loss=None, min_timestamp=context.current_timestamp, max_timestamp=pd.Timestamp("20250101"), reason="testOpen")
